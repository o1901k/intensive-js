...
3) Напишите функцию, которая будет проходить через массив целых чисел и выводить индекс каждого элемента с задержкой в
3 секунды.
...
Глобальный await может использоваться за пределами асинхронной функции. Он превращении модули в подобие асинхронных функций.
Модули, которые импортируют ресурсы, запускают выполнение кода только после получения ресурсов и их подготовки к использованию.
